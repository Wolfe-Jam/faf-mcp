...
function checkFafCli() {
  try {
    ...
    console.error('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━');
    console.error('');
    console.error('faf-mcp requires faf-cli to be installed FIRST.');
    console.error('');
    console.error('CORRECT INSTALLATION ORDER:');
    console.error('  1️⃣  npm install -g faf-cli    (DO THIS FIRST)');
    console.error('  2️⃣  npm install -g faf-mcp    (ALREADY DONE)');
    console.error('');
    console.error('Please install faf-cli now:');
    console.error('  npm install -g faf-cli');
    console.error('');
    console.error('Then restart your IDE/editor to use all MCP features.');
    console.error('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━');
    console.error('');
    return false;
  }
